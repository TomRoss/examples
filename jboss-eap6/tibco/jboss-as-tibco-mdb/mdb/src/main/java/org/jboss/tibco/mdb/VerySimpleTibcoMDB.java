...
@MessageDriven(name = "VerySimpleTIBCOMDB", activationConfig = {
        ...
        @ActivationConfigProperty(propertyName = "jndiParameters", propertyValue = "java.naming.security.principal=admin;java.naming.security.credentials=admin;java.naming.factory.initial=com.tibco.tibjms.naming.TibjmsInitialContextFactory;java.naming.provider.url=tcp://ragga:7222;java.naming.factory.url.pkgs=com.tibco.tibjms.naming"),
...
public class VerySimpleTibcoMDB implements MessageListener {
    private static final Logger log = Logger.getLogger(VerySimpleTibcoMDB.class.getName());
    ...
    @Resource (mappedName = "java:/jms/tomr")
