 ...
 */
@MessageDriven(name = "RemoteTopicMDBRA", activationConfig = {
        @ActivationConfigProperty(propertyName = "destinationType", propertyValue = "javax.jms.Topic"),
        @ActivationConfigProperty(propertyName = "destination", propertyValue = "testTopicRA"),
...
},mappedName = "java:jboss/jms/topic/testTopicRA")
          
 @ResourceAdapter("remote-hornetq-ra")
public class RemoteTopicMDB_RA implements MessageListener {

    private final static Logger log = Logger.getLogger(RemoteTopicMDB_RA.class.toString());
