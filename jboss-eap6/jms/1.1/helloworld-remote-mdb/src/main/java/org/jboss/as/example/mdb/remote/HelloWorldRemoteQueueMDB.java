...
public class HelloWorldRemoteQueueMDB implements MessageListener {

    private final static Logger log = Logger.getLogger(HelloWorldRemoteQueueMDB.class.toString());
    ...
    public HelloWorldRemoteQueueMDB() {
